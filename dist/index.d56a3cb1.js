...
function className(region) {
    let p = "";
    if (region === 'Asia') p = "asia";
    else if (region === "Europe") p = 'europe';
    else if (region === "Americas") p = 'americas';
    else if (region === "Oceania") p = 'oceania';
    else if (region === "Africa") p = 'africa';
    return p;
}
...
},{"axios":"1IeuP"}],"1IeuP":[function(require,module,exports) {
...
},{"./../utils":"60BxC"}]},["1Mq12","5HwUs"], "5HwUs", "parcelRequirecb08")
